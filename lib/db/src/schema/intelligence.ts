...
export const irs990Raw = pgTable(
  "irs_990_raw",
  {
    ...
    subseccd: varchar("subseccd", { length: 3 }),
    operatehosptlcd: char("operatehosptlcd", { length: 1 }),
    ...
    txexmptbndcd: char("txexmptbndcd", { length: 1 }),
    rptlndbldgeqptcd: char("rptlndbldgeqptcd", { length: 1 }),
    s501c3or4947a1cd: char("s501c3or4947a1cd", { length: 1 }),
    ingestedAt: timestamp("ingested_at", { withTimezone: true }).defaultNow(),
    updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow(),
  },
  (t) => [
